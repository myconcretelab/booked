...
class Booked_Shortcode
{
    ...
    {
        wp_register_style('booked-widget', BOOKED_PLUGIN_URL . 'assets/widget.css', [], '0.3.22');
        wp_register_script('booked-widget', BOOKED_PLUGIN_URL . 'assets/widget.js', [], '0.3.23', true);
