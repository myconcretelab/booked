...
class Booked_Shortcode
{
    ...
    {
        wp_register_style('booked-widget', BOOKED_PLUGIN_URL . 'assets/widget.css', [], '0.3.35');
        ...
        wp_register_script('booked-gite-cards', BOOKED_PLUGIN_URL . 'assets/gite-cards.js', ['booked-widget'], '0.3.2', true);
